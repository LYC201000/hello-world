...
class AddActionListener2 implements ActionListener {
	...
	public AddActionListener2( JDBC_Manager2 jdbcManager2,JTable table, JTextField text1, JTextField text2,
			JComboBox genderComboBox) {
		super();
		this.table = table;
		this.text1 = text1;
	...
	public AddActionListener2(JDBC_Manager2 jdbcManager2,
							JTable table, 
							JTextField text1,
							JTextField text2, 
							JTextField text3) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 레코드에 데이터 추가
		try {
		jdbcManager2.insertTable2(arr);
		System.out.println("레코드에 데이터 추가");
		}catch (Exception ex) {
			ex.getMessage();
		}
		// 입력창 빈칸 만들기
